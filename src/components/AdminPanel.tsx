      ...
      {!isAdminAuthed ? (
        <div className="bg-slate-900 border border-slate-850 rounded-3xl p-6 sm:p-8 flex flex-col gap-6 shadow-xl w-full">
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-rose-600 to-amber-500 p-3 flex items-center justify-center text-white shadow-lg shadow-rose-600/10">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                Pusat Kawalan & Pemantauan Sistem Rengit Runner. Sila masukkan kelayakan pentadbir anda.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleAdminLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Masukkan username (cth: adminrr)"
                className="w-full bg-slate-950 border border-slate-800 focus:border-rose-500 rounded-xl px-4 py-3 text-xs text-white outline-none transition-all font-mono"
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Masukkan kata laluan (cth: 930404)"
                className="w-full bg-slate-950 border border-slate-800 focus:border-rose-500 rounded-xl px-4 py-3 text-xs text-white outline-none transition-all font-mono"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-rose-600 hover:bg-rose-500 text-white text-xs font-black rounded-xl flex items-center justify-center gap-2.5 transition-all cursor-pointer shadow-lg shadow-rose-600/15"
            >
              <LogIn className="w-4 h-4" />
              <span>Sahkan & Masuk Ke Portal</span>
            </button>
          </form>

          <div className="border-t border-slate-800/80 pt-4 mt-1">
            <div className="flex gap-2.5 items-start text-[10px] text-slate-500 leading-normal bg-slate-950/40 p-3 rounded-xl border border-slate-850/80">
              <ShieldAlert className="w-4 h-4 text-rose-500 flex-shrink-0 mt-0.5" />
              <div>
                <p className="font-bold text-slate-400">Nota Keselamatan Pentadbir:</p>
                <p className="mt-0.5">Sila gunakan username <span className="text-rose-400 font-bold font-mono">adminrr</span> dan password <span className="text-rose-400 font-bold font-mono">930404</span> untuk mengakses data simulasi.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <>
          ...
          <div className="bg-slate-900 border border-slate-850 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-lg">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 flex items-center justify-center">
                <Shield className="w-5 h-5 animate-pulse" />
              </div>
              <div>
                <p className="text-[10px] uppercase font-bold text-rose-400">Log Masuk Sebagai</p>
                <p className="text-xs font-black text-white">Administrator (adminrr)</p>
              </div>
            </div>
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-3 py-1.5 bg-slate-950 hover:bg-red-950/30 text-slate-400 hover:text-red-400 border border-slate-850 hover:border-red-900/20 rounded-xl text-xs font-bold transition-all cursor-pointer"
            >
